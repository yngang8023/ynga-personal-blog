...
export const zh_TW: Translation = {
	...
	[Key.archive]: "歸檔",
	[Key.search]: "搜尋",
	[Key.searchDevFakeTitle]: "這是一個開發環境下的模擬搜尋結果",
	[Key.searchDevFakeExcerpt]:
		"因為搜尋功能在 <mark>dev</mark> 開發環境中無法正常運作。",
	[Key.searchDevGuideTitle]: "如果你想測試搜尋功能",
	[Key.searchDevGuideExcerpt]:
		"請改用 <mark>npm build && npm preview</mark> 進行測試。",
	[Key.other]: "其他",
	...
	[Key.postList]: "文章列表",
	[Key.postListEmpty]: "還沒有可瀏覽的文章",
	[Key.postListEmptyDescription]: "發佈文章後，這裡會按時間列出最新內容。",
	[Key.tableOfContents]: "目錄",
	[Key.tocEmpty]: "當前頁面沒有目錄",
	[Key.tocEmptyDescription]: "添加標題後，這裡會自動生成當前文章的閱讀導覽。",
	[Key.tagsEmpty]: "還沒有標籤",
	[Key.tagsEmptyDescription]: "給文章補上標籤後，這裡會自動整理成標籤索引。",
	[Key.categoriesEmpty]: "還沒有分類",
	...
	[Key.musicPlayerLyricsFailed]: "歌詞載入失敗",
