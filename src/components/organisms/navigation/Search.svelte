	...
	const fakeResult: SearchResult[] = [
		{
			url: url("/"),
			meta: {
				title: i18n(I18nKey.searchDevFakeTitle),
			},
			excerpt: i18n(I18nKey.searchDevFakeExcerpt),
		},
		{
			url: url("/"),
			meta: {
				title: i18n(I18nKey.searchDevGuideTitle),
			},
			excerpt: i18n(I18nKey.searchDevGuideExcerpt),
		},
	];
