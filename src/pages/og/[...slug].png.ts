...
type SatoriRenderable = Parameters<typeof satori>[0];
type SatoriProps = Record<string, unknown> & {
	children?: SatoriRenderable | SatoriRenderable[];
	style?: Record<string, string | number>;
};

function createSatoriNode(type: string, props: SatoriProps = {}): SatoriRenderable {
	return {
		type,
		key: null,
		props,
...
export async function GET({
	...
	const template: SatoriRenderable = createSatoriNode("div", {
		style: {
			height: "100%",
			width: "100%",
			display: "flex",
