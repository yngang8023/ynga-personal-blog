...
export const ja: Translation = {
	...
	[Key.archive]: "アーカイブ",
	[Key.search]: "検索",
	[Key.searchDevFakeTitle]: "これは開発環境用のダミー検索結果です",
	[Key.searchDevFakeExcerpt]:
		"検索機能は <mark>dev</mark> 開発環境では正常に動作しません。",
	[Key.searchDevGuideTitle]: "検索機能を確認したい場合",
	[Key.searchDevGuideExcerpt]:
		"<mark>npm build && npm preview</mark> を使って確認してください。",
	[Key.other]: "その他",
	...
	[Key.postList]: "投稿の一覧",
	[Key.postListEmpty]: "まだ閲覧できる投稿がありません",
	[Key.postListEmptyDescription]:
		"投稿を公開すると、ここに新しい記事が自動で一覧表示されます。",
	[Key.tableOfContents]: "目次",
	[Key.tocEmpty]: "目次はありません",
	[Key.tocEmptyDescription]:
		"見出しを追加すると、このページの読み進めガイドが自動で生成されます。",
	[Key.tagsEmpty]: "まだタグがありません",
	[Key.tagsEmptyDescription]:
		"投稿にタグを付けると、このウィジェットが自動でタグ一覧になります。",
	[Key.categoriesEmpty]: "まだカテゴリーがありません",
	[Key.categoriesEmptyDescription]:
		"投稿にカテゴリーを設定すると、テーマごとにここへ自動で整理されます。",
