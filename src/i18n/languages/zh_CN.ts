...
export const zh_CN: Translation = {
	...
	[Key.archive]: "归档",
	[Key.search]: "搜索",
	[Key.searchDevFakeTitle]: "这是一个开发环境下的模拟搜索结果",
	[Key.searchDevFakeExcerpt]:
		"因为搜索功能在 <mark>dev</mark> 开发环境中无法正常工作。",
	[Key.searchDevGuideTitle]: "如果你想测试搜索功能",
	[Key.searchDevGuideExcerpt]:
		"请改用 <mark>npm build && npm preview</mark> 进行测试。",
	[Key.other]: "其他",
	...
	[Key.postList]: "文章列表",
	[Key.postListEmpty]: "还没有可浏览的文章",
	[Key.postListEmptyDescription]: "发布文章后，这里会按时间列出最新内容。",
	[Key.tableOfContents]: "目录",
	[Key.tocEmpty]: "当前页面没有目录",
	[Key.tocEmptyDescription]: "添加标题后，这里会自动生成当前文章的阅读导航。",
	[Key.tagsEmpty]: "还没有标签",
	[Key.tagsEmptyDescription]: "给文章补充标签后，这里会自动整理成标签索引。",
	[Key.categoriesEmpty]: "还没有分类",
	...
	[Key.musicPlayerLyricsFailed]: "歌词加载失败",
	...
	// 技能展示页面
	[Key.skills]: "技能展示",
	[Key.skillsSubtitle]: "以 Java 后端为主，持续探索 AI Agent 与全栈协作开发",
