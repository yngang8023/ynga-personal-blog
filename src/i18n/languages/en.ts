...
export const en: Translation = {
	...
	[Key.archive]: "Archive",
	[Key.search]: "Search",
	[Key.searchDevFakeTitle]: "This Is a Fake Search Result",
	[Key.searchDevFakeExcerpt]:
		"Because the search cannot work in the <mark>dev</mark> environment.",
	[Key.searchDevGuideTitle]: "If You Want to Test the Search",
	[Key.searchDevGuideExcerpt]:
	...
	[Key.postListEmpty]: "No posts to browse yet",
	[Key.postListEmptyDescription]:
		"Once you publish posts, the latest entries will appear here automatically.",
	[Key.tableOfContents]: "Table of Contents",
	[Key.tocEmpty]: "No table of contents",
	[Key.tocEmptyDescription]:
		"Add headings and this page will generate a reading outline automatically.",
	[Key.tagsEmpty]: "No tags yet",
	[Key.tagsEmptyDescription]:
		"Add tags to your posts and this widget will turn into a tag index automatically.",
	[Key.categoriesEmpty]: "No categories yet",
	[Key.categoriesEmptyDescription]:
		"Assign categories to your posts and different topics will be grouped here automatically.",
	...
	[Key.musicPlayerLyricsEmpty]: "No lyrics available",
	[Key.musicPlayerLyricsLoading]: "Loading lyrics...",
	[Key.musicPlayerLyricsFailed]: "Failed to load lyrics",
